...
public partial class NewBankAccountServiceTests : IClassFixture<WiremockFixture>
{
    private readonly WiremockFixture _wiremockFixture;

    public WireMockServer Server => _wiremockFixture.Server;

    public NewBankAccountServiceTests(WiremockFixture wiremockFixture)
    {
